...
const Details = () => {
    return (
        ...
        <div className="z-10 flex w-full flex-row">
          ...
          <div
            className="basis-full px-5 text-5xl font-bold leading-[55px] tracking-wide md:px-16 xl:basis-5/12 xl:px-0"
          >
            Unique and Authentic Vintage Designer Jewellery
          </div>
        </div>
        <div
          className="z-0 -mt-[104px] flex w-full flex-col space-x-0 space-y-10 bg-[#eaeffa57] px-10 pb-10 pt-32 md:-mt-[56px] md:pt-24 xl:flex-row xl:space-x-10 xl:space-y-0"
        >
          <div
            className="relative flex basis-1/2 flex-col items-center justify-center space-y-8 text-[#212121]"
          >
            <div
              className="flex basis-1/2 flex-col justify-between space-y-8 sm:flex-row sm:space-x-14 sm:space-y-0"
            >
            ...
            <div className="absolute inset-0 -z-40 flex items-center justify-center">
              <div
                className="text-[60px] font-bold text-gray-200 sm:text-[75px] sm:font-bold md:text-8xl md:font-extrabold"
              >
          ...
          >
            ...
            >
              ...
              <Link className="z-40" href="/products">
                  <button
                  className="w-fit cursor-pointer whitespace-nowrap bg-[#212121] px-5 py-2 text-white sm:w-2/3 sm:whitespace-normal"
                >
                  See All Product
                </button>
              </Link>
